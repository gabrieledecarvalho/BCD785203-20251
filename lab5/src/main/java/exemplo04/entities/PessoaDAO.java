...
public abstract class PessoaDAO {
    ...
    public final static boolean adiciona(Pessoa p) throws SQLException {
        ...
        String sql = "INSERT INTO Pessoa (nome, peso, altura, email) VALUES (?,?,?,?)"; // Define a string SQL com parâmetros ? para evitar SQL Injection.
        // Try-with-resources para garantir que a conexão e statement sejam fechados automaticamente, evitando vazamento de recursos
        try (Connection conexao = ConnectionFactory.getDBConnection();
             // PreparedStatement para preencher esses parâmetros de forma segura.
